...
from models import MiniConvNet
...
def objective(trial):
    ...
    model_dir = Path(f"optuna_models_MiniConvNet/features_{num_features}_layers_{num_hidden_layers}_run_{run_id}")
        ...
        torch.save(
            {
                ...
                "model_kwargs": {"num_features": num_features, "num_hidden_layers": num_hidden_layers},
...
if __name__ == "__main__":
    ...
    # save study
    import joblib
    joblib.dump(study, f"optuna_models_MiniConvNet/study_optuna_models_MiniConvNet.pkl")
